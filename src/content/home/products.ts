...
export const productCategories = [
  {
    ...
    highlights: [
      'Iodine value up to 1200+ mg/g',
      'High hardness > 95%',
      'Low ash content < 5%',
    ],
    applications: ['Drinking water', 'Gold recovery (CIP/CIL)', 'Air purification'],
  },
  {
    ...
    applications: ['Municipal water treatment', 'Industrial wastewater', 'Solvent recovery'],
  },
  {
    ...
    highlights: [
      'High methylene blue value',
      'Food-grade certified',
      'Low heavy metal content',
    ],
    applications: ['Sugar decolorization', 'Food & beverage', 'Pharmaceutical purification'],
  },
  {
    ...
    highlights: [
      ...
      'Custom impregnation ratios',
      'Mercury & H₂S specialist',
    ],
    applications: ['Nuclear & radioactive iodine', 'Mercury removal', 'H₂S & acid gas treatment'],
  },
];
