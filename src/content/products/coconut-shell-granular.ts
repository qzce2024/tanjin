import productImage from '../../assets/images/products/coconut-shell-granular-activated-carbon-supplier.png';

export const coconutShellGranularData = {
  meta: {
...
<h2>Applications</h2>
<ul>
<li>Drinking water treatment and purification</li>
<li>Industrial wastewater treatment</li>
<li>Air purification and odor removal</li>
<li>Gold recovery in mining operations</li>
